...
class YahooJapanTest extends TestCase
{
    ...
    {
        $authUser = json_decode('{"ok": true,"url": "https:\/\/myteam.slack.com\/","team": "My Team","user": "cal","team_id": "T12345","user_id": "U12345"}',
            true);
    ...
    public function testGetAccessToken()
    {
        ...
        $response->allows([
            'getBody' => '{"access_token": "mock_access_token", "expires_in": 3600}',
    ...
    /**
     * @expectedException YahooJapanIdentityProviderException
     */
